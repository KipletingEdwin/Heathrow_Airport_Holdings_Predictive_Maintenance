...
def verify_target_distribution(df):
    ...
    print(f" Imbalance Ratio: {round((failure_count/total)*100 )}% Breakdown Rate.")
...
def execute_feature_stripping(df):
    ...
    # Separate feature columns conceptually for encoding and scaling downstream
    ...
    print(f" Refactored column names: {list(X_encoded.columns)}")
